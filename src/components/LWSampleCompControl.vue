...
import LWSampleComp from '@/components/LWSampleComp.vue';
...
const chartOptions = ref({ width: 400, height: 300 });
...
<template>
    ...
    <Button label="Secondary" severity="secondary" rounded @click="changeColors">Set Random Colors</Button>
    <Button label="Secondary" severity="secondary" rounded @click="changeType">Change Chart Type</Button>
    <Button label="Secondary" severity="secondary" rounded @click="changeData">Change Data</Button>
</template>
<style scoped>
.chart-container {
